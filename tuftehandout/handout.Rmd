---
title: "Visualisation of the German Census Data"
subtitle: "the `raster`-package and it's main concepts"
author: "Robin Kohrs"
date: "28-01-2020"
output:
  tufte::tufte_html:
...
- Daten zu Bevölkerung, Erwerbstätigkeit, Gebäude- und WOhnungsbestand häufig in .csv-format
...
- Dann werden die wichtigen Variablen ausgewählt. Wichtig: *X* und *Y* müssen in der 1. und 2. Spalte sein
- Anschließend werden die fehlenden Werte mir `NA` kodiert
- Zu letzt wird der `data.frame` in einen `RasterBrick` konvertiert
...
- Als Nächstes wird das Objekt der Klasse `Rasterbrick`zu einem`RasterStack`  
